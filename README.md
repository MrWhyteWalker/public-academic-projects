...
---
## Projects included:
**[School Events Matrix](./school-events-matrix)** - Advanced Vanilla JS SPA utilizing public Holiday APIs, responsive CSS container queries, and a custom History API router.
## 🛠️ Project Directory Index

### 1. 📅 School Event Matrix (Vanilla JS SPA)
* **Directory:** [`/school-event-matrix`](./school-events-matrix)
